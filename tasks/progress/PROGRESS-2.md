...
**Dependencies:** [PROGRESS-1](../progress/PROGRESS-1.md)

## Goal

Turn recorded sessions and app use into local daily summaries that remain credible across date and clock changes.
